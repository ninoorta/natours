...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoibmlub29ydGEiLCJhIjoiY2t2NmluYjFxMDJyNDJ3bWdiOG1mc3NkdSJ9.-fJbN_y9_WC7z9nZPjRAWA';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateCurrentUser';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51JpqpJGiICqKg8GEPXeYyptV7TH6x4Lrg0Ml0jg3KvJK7wQcQp9vUFFPOEgHl2ctJuExJYjiZG28uy1NSuVgItQU00b2LL0rE1');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    document.getElementById('btn-login').innerText = 'Processing';
    document.getElementById('btn-login').disabled = true;
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var form = new FormData(); // This helps to create a multipart form data
